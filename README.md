 ...
 **МЕТРИКИ**
 ...
 - ТОР-5 наиболее уверенных ошибок модели.
 ...
 **ВЫВОД:** Сейчас абсолютно все выявленные ошибки и модели и пайплайна и самих данных укладываются в менее чем 12%. Предполагается, что оператор укажет вручную порядка 144 имен из 1200. Остальные будут быстро прокликаны при автоматической подстановке правильного имени.
 ...
 PS: Сергей, спасибо огромное за 2-ой шанс! Вообще, данное описание проекта все время находилось в METHODOLOGY.md в папке с проектом. Гугл не рекомендовал делать такое пространное описание в readme.md, а рекомендовал оставить там только минимум необходимой информации. Я, к сожалению, его послушала. Сейчас вынесла всю информацию сюда и добавила скрины, чтобы тебе не нужно было просматривать разные файлы, а посмотреть всю логику в одном месте. Здесь. Если все-таки Михаилу тоже будет интересено потестить мой проект, готова оперативно доработать то что понадобится для удобства работы операторов и внести правки, описанные выше. Просто метрика получилась очень не плохая. Лучше, чем у некоторых проектов, которые презентовали вчера. Жалко если проект не принесет никому пользы... После ревью удалю PS